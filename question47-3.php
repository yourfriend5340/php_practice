...
<html lang="en">
<head>
    <script src="js/question47-3.js?20240923" defer></script>
...
<body class="indexBody">
    ...
    <hr>
    <form class="form1" action="question47-3.php" id="question47" method="GET">
    ...
    if(isset($_GET['47input']))
    {
        ...
        echo "<table class='question47-3SubTable'>
                <thead>
        ...
        for ($i=1;$i<=$Arr_count;$i++)
        {
            ...
            echo "<td><table class='question47-3Sub2Table'><tdoby>";
            ...
            for($j=1;$j<=9;$j++)
            {
                ...
                echo "<tr>
                        ...
                        "<td class='alignEnd'>".$outputHtml."</td>
                    </tr>";
            }
            echo "</tbody></table></td>";
