...
<html lang="en">
<head>
    <script src="js/question47-2.js?20240923" defer></script>
...
<body class="indexBody">
    ...
    <hr>
    <form class="form1" action="question47-2.php" id="question47-2" method="GET">
...
<!--                    <label for="47check">是否製作練習題</label>-->
    ...
    if(isset($_GET['47input']))
    {
        ...
        echo "<table class='question47-2SubTable'>
                <thead>
        ...
        for ($i=1;$i<=$Arr_count;$i++)
        {
            ...
            echo "<td><table class='question47-2Sub2Table'><tdoby>";
